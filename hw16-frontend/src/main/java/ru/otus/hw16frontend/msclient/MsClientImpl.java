...
public class MsClientImpl implements MsClient {
    ...
    public MsClientImpl(@Value("${service.frontend.name}") String name,
                        FrontendSocketClient frontendSocketClient) {
        this.name = name;
    ...
    public boolean sendMessage(Message msg) {
        boolean result = frontendSocketClient.newMessage(msg);
        if (!result) {
